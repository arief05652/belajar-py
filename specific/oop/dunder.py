...
class Aritmatik:
    ...
    """
    overload tag @ dipakai dengan 2 tipe yang berbeda
    """

    @overload
    def __init__(self, a: int, b: int, data: list | None) -> None: ...

    @overload
    def __init__(self, a: str, b: str, data: list | None) -> None: ...

    # proses tipe overload
    def __init__(self, a: str | int, b: str | int, data: list | None) -> None:
        # inisiasi class
